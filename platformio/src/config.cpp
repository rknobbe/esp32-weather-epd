...
// WIFI
const char *WIFI_SSID     = "soundslikeobitwo";
const char *WIFI_PASSWORD = "soundslikeOB1";
...
const String OWM_APIKEY   = "6182f0cfc5eea87325bb93aa1852b50f";
...
const String LAT = "33.85";
const String LON = "-118.26";
// City name that will be shown in the top-right corner of the display.
const String CITY_STRING = "Torrance";
